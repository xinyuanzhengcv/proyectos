...
2. **R**  
   ...
   Modelos utilizados incluyen regresión lineal y regularizada (GLM, GLMNET), Redes Neuronales, Random Forest, XGBoost, LightGBM y Support Vector Machines (lineal, polinómico y radial).
